...
В результате выбран уровень детализации **«одна строка = одна позиция в заказе»**, обеспечивающий максимальную гибкость аналитики и позволяющий отвечать на все ключевые бизнес-вопросы ресторана.
...
| VisitKey | INT | NOT NULL | Идентификатор визита |
